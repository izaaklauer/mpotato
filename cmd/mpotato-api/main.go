...
import (
	...
	"github.com/izaaklauer/mpotato/server"
...
func main() {
	fmt.Println("starting mpotato.......")
	defer fmt.Println("mpotato exiting!")
...
func serve() error {
	...
	// Start the service
	mpotatoServer, err := server.NewMpotatoServer(c.Mpotato)
	if err != nil {
		return errors.Wrapf(err, "failed to start mpotato server")
	}
	...
	mpotatov1.RegisterMpotatoServiceServer(grpcServer, mpotatoServer)
